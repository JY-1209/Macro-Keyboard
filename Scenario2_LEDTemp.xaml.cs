...
namespace Macro_Keyboard
{
    ...
    public sealed partial class Scenario2_LEDTemp : Page, IDisposable
    {
        ...
        private void Button3Press_Click(object sender, RoutedEventArgs e)
        {

        }

    //    private async void ButtonPress(String PinNumber)
    //    {
    //        if (EventHandlerForDevice.Current.IsDeviceConnected)
    //        {
    //            try
    ...
    //                {
    //                    case LedState.LedStateOn:
    //                        DataWriterObject.WriteString("ledon " + PinNumber + "\r");
    //                        break;

    //                    case LedState.LedStateOff:
    //                        DataWriterObject.WriteString("ledoff " + PinNumber + "\r");
    //                        break;
